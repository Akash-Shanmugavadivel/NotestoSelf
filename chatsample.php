    ...
    <div class="container" style=" width: 800px;">
        ...
        <div class="chat-box" id="chatBox">
            <?php foreach ($messages as $message): ?>
               <!-- Add this updated HTML code inside the foreach loop for chat messages -->
<div class="chat-message" data-message-id="<?php echo $message['id']; ?>" ondblclick="showActions(this)">
  ...
  <button class="print-button" onclick="printChat()" style="color:white;">Print</button>
    ...
    var selectedNoteTitle = document.querySelector('select[name="selected-note"] option:checked').innerText;
    ...
    printWindow.document.write('<h1>Chat Messages for Note: ' + selectedNoteTitle + '</h1>');
