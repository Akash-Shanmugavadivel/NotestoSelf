...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["note"]) && !empty($_POST["note"])) {
        ...
        $selectedNoteId = $_POST['selected-note'];
            ...
            <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                <select name="selected-note">
                    <?php foreach ($noteTitles as $noteTitle): ?>
                        <option value="<?php echo $noteTitle['id']; ?>" <?php if(isset($_POST['submit']) && ($_POST['selected-note']==$noteTitle['id'])){echo "selected='selected'";} ?>><?php echo $noteTitle['title']; ?></option>
                    <?php endforeach; ?>
                </select>
